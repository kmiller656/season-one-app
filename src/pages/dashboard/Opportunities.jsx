...
import { compMidpointAnnual, formatDate } from '../../lib/format'
...
function OpportunityCard({ match, expanded, onToggle, onStatus, busy }) {
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Detail
              ...
              value={
                o.compensation
                  ? `${o.compensation}${
                      o.compensation_type ? ` (${o.compensation_type})` : ''
                    }`
                  : null
              }
            />
...
export default function Opportunities({ initialPositionType = '', heading }) {
  ...
  const specialtyOptions = useMemo(() => {
    const set = new Set(
      matches.map((m) => m.opportunity.specialty).filter(Boolean)
    )
